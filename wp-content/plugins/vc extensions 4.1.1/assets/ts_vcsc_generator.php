						...
						<form id="ts_tiny_tinymce_form" name="ts_tiny_tinymce_form" autocomplete="off" style=""/>
							<table id="ts_tiny_tinymce_table_icon" class="ts_tiny_form ts_tiny_table ts_tiny_tinymce_table_icon" cellspacing="0" style="">
								...
								<tr>
									...
									<td style="padding-top: 20px;">
										<div id="ts-tiny-tinymce-iconback" class="toggle toggle-light" data-checkbox="ts-tiny-tinymce-iconback-check" style="width: 70px;" data-on="<?php __( "Yes", "ts_visual_composer_extend" ); ?>" data-off="<?php __( "No", "ts_visual_composer_extend" ); ?>">
											<div class="toggle-slide">
												<div class="toggle-inner">
								...
								<tr>
									...
									<td style="padding-top: 20px;">
										<div id="ts-tiny-tinymce-iconhoverchange" class="toggle toggle-light" data-checkbox="ts-tiny-tinymce-iconhoverchange-check" style="width: 70px;" data-on="<?php __( "Yes", "ts_visual_composer_extend" ); ?>" data-off="<?php __( "No", "ts_visual_composer_extend" ); ?>">
											<div class="toggle-slide">
												<div class="toggle-inner">
													<div class="toggle-on"><?php __( "Yes", "ts_visual_composer_extend" ); ?></div>
													<div class="toggle-blob"></div>
								...
								<tr>
									...
									<td style="padding-top: 20px;">
										<div id="ts-tiny-tinymce-iconborder" class="toggle toggle-light" data-checkbox="ts-tiny-tinymce-iconborder-check" style="width: 70px;" data-on="<?php __( "Yes", "ts_visual_composer_extend" ); ?>" data-off="<?php __( "No", "ts_visual_composer_extend" ); ?>">
											<div class="toggle-slide">
												<div class="toggle-inner">
													<div class="toggle-on"><?php __( "Yes", "ts_visual_composer_extend" ); ?></div>
													<div class="toggle-blob"></div>
								...
								<tr>
									...
									<td style="padding-top: 20px;">
										<div id="ts-tiny-tinymce-iconpadding" class="toggle toggle-light" data-checkbox="ts-tiny-tinymce-iconpadding-check" style="width: 70px;" data-on="<?php __( "Yes", "ts_visual_composer_extend" ); ?>" data-off="<?php __( "No", "ts_visual_composer_extend" ); ?>">
											<div class="toggle-slide">
												<div class="toggle-inner">
													<div class="toggle-on"><?php __( "Yes", "ts_visual_composer_extend" ); ?></div>
													<div class="toggle-blob"></div>
								...
								<tr>
									...
									<td style="padding-top: 20px;">
										<div id="ts-tiny-tinymce-iconmargin" class="toggle toggle-light" data-checkbox="ts-tiny-tinymce-iconmargin-check" style="width: 70px;" data-on="<?php __( "Yes", "ts_visual_composer_extend" ); ?>" data-off="<?php __( "No", "ts_visual_composer_extend" ); ?>">
											<div class="toggle-slide">
												<div class="toggle-inner">
													<div class="toggle-on"><?php __( "Yes", "ts_visual_composer_extend" ); ?></div>
													<div class="toggle-blob"></div>
								...
								<tr>
									...
									<td style="padding-top: 20px;">
										<div id="ts-tiny-tinymce-iconlink" class="toggle toggle-light" data-checkbox="ts-tiny-tinymce-iconlink-check" style="width: 70px;" data-on="<?php __( "Yes", "ts_visual_composer_extend" ); ?>" data-off="<?php __( "No", "ts_visual_composer_extend" ); ?>">
											<div class="toggle-slide">
												<div class="toggle-inner">
													<div class="toggle-on"><?php __( "Yes", "ts_visual_composer_extend" ); ?></div>
													<div class="toggle-blob"></div>
								...
								<tr>
									...
									<td style="padding-top: 20px;">
										<div id="ts-tiny-tinymce-iconinline" class="toggle toggle-light" data-checkbox="ts-tiny-tinymce-iconinline-check" style="width: 70px;" data-on="<?php __( "Yes", "ts_visual_composer_extend" ); ?>" data-off="<?php __( "No", "ts_visual_composer_extend" ); ?>">
											<div class="toggle-slide">
												<div class="toggle-inner">
